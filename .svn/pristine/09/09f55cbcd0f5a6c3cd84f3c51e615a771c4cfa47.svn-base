...
@WebServlet("/ManagerSheduleInfo.do")

public class ManagerSheduleInfoController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("관리자 스케줄 관리 페이지");
		...
		// 서비스 객체 얻기
		IManagerSheduleService service= ManagerSheduleServiceImpl.getInstance();
		// 전체 글 갯수 조회하기
		int totalCount = service.countShedule();
...
//		}
		...
		// 범위 별 게시물 조회
		List<SheduleVo> list = service.selectShedule(map);
