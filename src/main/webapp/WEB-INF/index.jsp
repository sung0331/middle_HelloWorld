...
<body>
	...
	<%
	} else if (main == "productDetail") {
	%>
	<%@include file="./view/product/productDetail.jsp"%>
	<%
	} else if (main == "productMain") {
	%>
	<%@include file="./view/product/productMain.jsp"%>
	<%
	} else if (main == "pay") {
	%>
	<%@include file="./view/pay/pay.jsp"%>
	<%
	} else if (main == "payEnd") {
	%>
	<%@include file="./view/pay/payEnd.jsp"%>
	<%
	} else if (main == "event") {
	%>
	<%@include file="./view/main/event.jsp"%>
	<%
	} else if (main == "mainRide") {
	%>
	<%@include file="./view/main/ride.jsp"%>
	<%
	} else if (main == "mainRideDetail") {
	%>
	<%@include file="./view/main/rideDetail.jsp"%>
	<%
	} else if (main == "faq") {
	%>
	<%@include file="./view/main/faq.jsp"%>
	<%
	}
	%>
	<!-- 바텀디자인 넘침 방지용 -->
