...
<main>
		...
		<div class="content">
			...
			<table>
				...
				<tbody>
					...
					%>
					<tr>
						<td><%=board.getPost_no()%></td>
						<!-- 글번호 -->
						<td><a href="/board/view?postNo=<%=board.getPost_no()%>"><%=board.getTitle()%></a></td>
						<!-- 제목에 링크 추가 -->
						<td>
							<%
 ...
 %>
    ...
    function goToPage(pageNum) {
        location.href = "mypageReviews.do?page=" + pageNum;
    }
    ...
    function goToNextPage() {
        ...
        location.href = "mypageReviews.do?page=" + (lastPage + 1);
    }

    function goToPrevPage() {
        let firstPage = parseInt($('.pagination button').first().text()); // string -> number
        if (firstPage <= 1) return;
        location.href = "mypageReviews.do?page=" + (firstPage - 1);
    }
