...
<%
	List<empVo> empDepartment = (List<empVo>)request.getAttribute("empDepartment");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
 			<div class="content">
 			<section id="empDepartment" class="section">
               <table>
               	<h2>조직도</h2>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                   		 <%
                    		for(empVo emp : empDepartment){
                    	%>
                        <tr>
                            <td><%=emp.getEmp_no() %></td>
                            <td><%=emp.getEmp_name() %></td>
                            <td><%=emp.getCust_tel() %></td>
